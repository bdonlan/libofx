...
struct gengetopt_args_info
{
  ...
  int fipid_given ;	/**< @brief Whether fipid was given.  */
  int fid_given ;	/**< @brief Whether fid was given.  */
  int org_given ;	/**< @brief Whether org was given.  */
  int bank_given ;	/**< @brief Whether bank was given.  */
  int broker_given ;	/**< @brief Whether broker was given.  */
  int user_given ;	/**< @brief Whether user was given.  */
  int pass_given ;	/**< @brief Whether pass was given.  */
  int acct_given ;	/**< @brief Whether acct was given.  */
  int type_given ;	/**< @brief Whether type was given.  */
  int past_given ;	/**< @brief Whether past was given.  */
  int url_given ;	/**< @brief Whether url was given.  */
  int trid_given ;	/**< @brief Whether trid was given.  */
  int statement_req_given ;	/**< @brief Whether statement-req was given.  */
  int accountinfo_req_given ;	/**< @brief Whether accountinfo-req was given.  */
  int payment_req_given ;	/**< @brief Whether payment-req was given.  */
  int paymentinquiry_req_given ;	/**< @brief Whether paymentinquiry-req was given.  */
  int bank_list_given ;	/**< @brief Whether bank-list was given.  */
  int bank_fipid_given ;	/**< @brief Whether bank-fipid was given.  */
  int bank_services_given ;	/**< @brief Whether bank-services was given.  */
  int allsupport_given ;	/**< @brief Whether allsupport was given.  */
